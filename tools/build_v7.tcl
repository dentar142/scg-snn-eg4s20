# build_v7.tcl - synth v7 (1->32->64->128->3 stride-2 INT8 with per-channel M0)
set proj      scg_top_v7
set top       scg_top_v7
...
set rtl_paths [list "../rtl/scg_top_v7.v" "../rtl/scg_mac_array_v7.v"]
...
puts "============================================================"
puts " V7 Build complete"
puts " bitstream: build_v7/${proj}.bit"
puts "============================================================"
exit 0
